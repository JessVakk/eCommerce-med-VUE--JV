    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <router-link class="navbar-brand mt-2 mt-lg-0" to="/">
          <i class="fa-solid fa-cat me-2"></i> CatNext.se
        </router-link>
        <!-- Left links -->
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown text-light">
          <a
            ...
            aria-expanded="false"
          >
            <i class="fas fa-shopping-cart sh-cart"></i>
        ...
        <!-- Avatar -->
        <div class="dropdown text-light" v-if="loggedIn">
          <a
        ...
        <router-link to="/login" class="nav-link text-light" v-else>Login</router-link>
      </div>
      <!-- Right elements -->
    </div>
    <!-- Container wrapper -->
